...
async def set_thumb_cmd(e):
    ...
    await e.reply(
        "Thumbnail set. try using /tusettings to get more control. Can be used in private too."
    )
...
async def clear_thumb_cmd(e):
    ...
    await e.reply(
        "Thumbnail disabled. Try using /tusettings to get more control. Can be used in private too."
    )
